...
export const api = {
  ...
  // blocked dates
  getBlockedDates: () => request('/api/blocked-dates'),
  addBlockedDates: (dates: string[]) => request('/api/blocked-dates', { method: 'POST', body: JSON.stringify({ dates }) }),
  removeBlockedDates: (dates: string[]) => request('/api/blocked-dates', { method: 'DELETE', body: JSON.stringify({ dates }) }),
};
